...
const LoginForm = () => {
    ...
    return (
        <View className=''>
            ...
            <InputCard icons={icons.lock} value={passWord} setValue={setPassWord} placeholder='Nhập mật khẩu' />

            <View className='mb-6'>
                <Text className='text-primary-300 underline text-lg'>Quên mật khẩu?</Text>
            </View>

            <TouchableOpacity className='bg-orange-600 p-4 items-center rounded-xl '>
